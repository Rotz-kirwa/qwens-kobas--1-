...
export const products: Product[] = [
  ...
  {
    id: "new-bundle",
    name: "The Complete Radiance Ritual Kit",
    price: 8000,
    originalPrice: 10650,
    rating: 5.0,
    reviews: 200,
    description: "All 5 essentials together. Transform faster with the full system and save 25% with free shipping on this limited bundle.",
    isBundle: true,
    image: "https://www.dropbox.com/scl/fi/srxgy8id5smigxy8vtepg/sp6.jpeg?rlkey=4s4p1hq245l9htmf3952f0xnb&st=ppngl85x&raw=1",
  },
  {
    id: "cleanser",
